  ...
  return (
    ...
    >
      <div className="container max-w-[1400px] w-[90%] mx-auto">
        <h1 className="text-2xl mb-4 text-center md:text-start text-white">
        ...
        <form action={formAction} className="max-w-[840px]">
          ...
          {statusMsg?.username && (
            <p className="text-red-500 mb-2 text-sm">{statusMsg.username}</p>
          )}
          ...
          {statusMsg?.password && (
            <p className="text-red-500 mb-2 text-sm">{statusMsg.password}</p>
          )}
